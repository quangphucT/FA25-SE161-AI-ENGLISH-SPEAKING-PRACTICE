              ...
              <div className="h-full">
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                  <div className="text-center">
                    ...
                    <h2 className="text-2xl font-bold text-slate-800 mb-3">Assessments</h2>
                    <p className="text-slate-600 mb-6 max-w-md mx-auto">
                      Manage student assessments, track progress, and provide evaluations.
                    </p>
              ...
              <div className="h-full">
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                  <div className="text-center">
                    ...
                    <h2 className="text-2xl font-bold text-slate-800 mb-3">Feedback Management</h2>
                    <p className="text-slate-600 mb-6 max-w-md mx-auto">
                      Provide detailed feedback to students and track their learning journey.
                    </p>
                    <Button className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white px-6 py-2">
                      Coming Soon
                    </Button>
                  </div>
                </div>
